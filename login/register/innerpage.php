...
#submit-btn{
  ...
  padding: 8px 8px;
        ...
        .Suggestion-thumbnail{/* Light gray */
        margin-bottom: 20px;
        width:250px;
        height: 120px;
        }
...
<body>
    <header class="header">
        ...
        <div class="right-section">
          <div class="upload-icon-container">
            <a href="land.php"> <img class="upload-icon" src="https://static.thenounproject.com/png/566743-200.png"></a>
          ...
          <div class="dropdown">
          <img class="current-user-picture" class="dropbtn" src="https://freesvg.org/img/abstract-user-flat-4.png">
            <div class="dropdown-content">
              <a href="/youtube/login/register/login.php">Login</a>
              <a href="#">
      ...
      <nav class="sidebar">
        <div class="sidebar-link">
          <a href="\youtube\youtube.php"> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Home-icon.svg/1024px-Home-icon.svg.png"></a>
          <div>Home</div>
        </div>
        <div class="sidebar-link">
    ...
    <div class="thumbnails-container">
        ...
        <iframe width="930" height="523"  src="\videos\video1.mp4" 
          title="Madara Uchiha VS Hashirama Senju &amp; Madara Uchiha VS Hashirama Senju" 
         allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
           allowfullscreen></iframe>
           <h3 class="title"> Madara Uchiha VS Hashirama Senju </h3>
           
        </div>
        <div  class="Suggestion-thumbnail-container" style="display: flex; flex-direction: column; width: 30%; margin-left: 30px;">
          <div style="display: flex;">
        <div class="Suggestion-thumbnail" >
        <iframe width="200" height="120" style="border-radius:3px;" src="videos\video1.mp4" 
          title="Madara Uchiha VS Hashirama Senju &amp; Madara Uchiha VS Hashirama Senju" 
         allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
           allowfullscreen></iframe>
        </div>
...
?>
        ...
        <div style="display: flex;">
          <div class="Suggestion-thumbnail" >
          <iframe width="200" height="120"  src="videos\video1.mp4" 
          title="Madara Uchiha VS Hashirama Senju &amp; Madara Uchiha VS Hashirama Senju" 
         allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
           allowfullscreen></iframe>
          </div>
          <h3  class="title">
          <?php
$sql = "SELECT title FROM videos where videoid=2 ";
...
?></h3>
          ...
          <div style="display: flex;">
            <div class="Suggestion-thumbnail">
            <iframe width="200" height="120"  src="videos\video1.mp4" 
          title="Madara &amp; Madara Uchiha VS Hashirama Senju" 
         allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
           allowfullscreen></iframe>
            </div>
            <h3 class="title">
...
<textarea rows="7" name="comments" cols="94" id="text" placeholder="comment here">

</textarea><br>
<button type="Submit" id="submit-btn" onclick="displaycomment()">Submit</button>
<h4 id="Name">
...
<script>
  function displaycomment (){
    ...
    document.getElementById("Name").innerHTML = "Hamza"
    document.getElementById("newcomment").innerHTML = input
